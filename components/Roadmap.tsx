...
const roadmapCardConfig = [
  ...
  },
  {
    justifyContent: "end",
    animation: "slideInRight",
    title: "roadmapTitle10",
    description: "roadmap10",
    color: "yellow",
    colorDark: "purple",
  },
  {
    justifyContent: "end",
    animation: "slideInRight",
    title: "roadmapTitle11",
    description: "roadmap11",
    color: "green",
    colorDark: "purple",
  },
  {
    justifyContent: "",
    animation: "slideInLeft",
    title: "roadmapTitle12",
    description: "roadmap12",
    color: "yellow",
    colorDark: "purple",
  },
  {
    justifyContent: "end",
    animation: "slideInRight",
    title: "roadmapTitle13",
    description: "roadmap13",
    color: "yellow",
    colorDark: "purple",
  },
];
